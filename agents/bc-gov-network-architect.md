...
| **Network-to-Network Connectivity Technical and Product Standard** | Companion to IMIT 5.08 \u2014 approved technical implementations and certified products for cross-network connectivity | [Standard](https://www2.gov.bc.ca/assets/gov/government/services-for-government-and-broader-public-sector/information-technology-services/standards-files/network_to_network_connectivity_technical_and_product_standard.pdf) |
